...
TRANSLATIONS["en"].update({
    ...
    "evaluation_title": "Pseudo-Labeled Evaluation Dataset", "evaluate_dataset": "Evaluate dataset",
    "evaluation_help": "Labels use the existing spot-percentage threshold and are not independent ground truth.",
    "evaluation_path": "Dataset location", "evaluation_missing": "Confusion Matrix requires independently labeled evaluation images.",
    "evaluation_empty": "No valid labeled images were found in the evaluation manifest or class folders.",
    ...
    "pseudo_labeled_notice": "These labels were generated by the same threshold rule used for predictions. The confusion matrix is not a performance evaluation; independent ground-truth labels are required.",
})
TRANSLATIONS["mr"].update({
    "segmentation_uncertain": "⚠️ केळीचे विभाजन अनिश्चित आहे. कृपया अधिक स्पष्ट फोटो अपलोड करा.",
    "evaluation_title": "Pseudo-Labeled Evaluation Dataset", "evaluate_dataset": "डेटासेटचे मूल्यमापन करा",
    "evaluation_help": "लेबल विद्यमान डाग-प्रमाण मर्यादेवरून तयार केली आहेत; ती स्वतंत्र ground truth नाहीत.",
    "evaluation_path": "डेटासेटचे स्थान", "evaluation_missing": "Confusion Matrix साठी स्वतंत्रपणे लेबल केलेल्या प्रतिमा आवश्यक आहेत.",
    "evaluation_empty": "मूल्यमापन मॅनिफेस्ट किंवा वर्ग फोल्डरमध्ये वैध लेबल असलेल्या प्रतिमा आढळल्या नाहीत.",

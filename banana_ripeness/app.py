...
st.markdown("""<style>
 ...
 h2, h3 { color:#163a27; font-weight:750; letter-spacing:-.015em; }
 ...
 [data-testid="stDataFrame"] { border:1px solid #e0e3d8; border-radius:12px; overflow:hidden; }
...
if analysis:
    ...
    st.markdown(f"### {t('color_analysis')}")
    fig, ax = plt.subplots(figsize=(6.4, 4.5))
    values = [analysis["green"], analysis["yellow"], analysis["brown"], analysis["dark"]]
    labels = [t("green"), t("yellow"), t("brown"), t("dark")]
    wedges, _, _ = ax.pie(values, colors=["#4fa65a", "#f5cb21", "#905631", "#3b3b3b"], autopct="%1.2f%%", pctdistance=.76, startangle=90, wedgeprops={"width": .46, "edgecolor": "white"}, textprops={"fontsize": 10})
    ax.set(aspect="equal")
